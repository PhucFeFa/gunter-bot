...
const RODS = [
    // Normal shop (id 1-10)
    { id: 1, name: 'Cần Tre', emoji: '🎋', price: 0, limited: false, tier: 1, bonusLuck: 0, bonusSize: 0, bonusTime: -0, maxDurability: 15, desc: 'Cần mặc định miễn phí. (15 độ bền)' },
    { id: 2, name: 'Cần Nhựa', emoji: '🎣', price: 50000, limited: false, tier: 1, bonusLuck: 2, bonusSize: 0.05, bonusTime: 1, maxDurability: 25, desc: 'Nhẹ và bền hơn cần tre. (25 độ bền)' },
    { id: 3, name: 'Cần Sợi Carbon', emoji: '🎣', price: 200000, limited: false, tier: 2, bonusLuck: 5, bonusSize: 0.1, bonusTime: 2, maxDurability: 45, desc: 'Sợi carbon nhẹ, cảm giác tốt hơn. (45 độ bền)' },
    { id: 4, name: 'Cần Thép', emoji: '🎣', price: 500000, limited: false, tier: 2, bonusLuck: 8, bonusSize: 0.15, bonusTime: 2, maxDurability: 70, desc: 'Bền, kéo được cá lớn hơn. (70 độ bền)' },
    { id: 5, name: 'Cần Chuyên Nghiệp', emoji: '🎣', price: 1000000, limited: false, tier: 3, bonusLuck: 12, bonusSize: 0.2, bonusTime: 3, maxDurability: 100, desc: 'Dành cho ngư dân có kinh nghiệm. (100 độ bền)' },
    { id: 6, name: 'Cần Titan', emoji: '🪝', price: 3000000, limited: false, tier: 3, bonusLuck: 18, bonusSize: 0.25, bonusTime: 4, maxDurability: 140, desc: 'Titan siêu bền, độ nhạy cao. (140 độ bền)' },
    { id: 7, name: 'Cần Biển Xanh', emoji: '🌊', price: 8000000, limited: false, tier: 4, bonusLuck: 25, bonusSize: 0.35, bonusTime: 5, maxDurability: 220, desc: 'Thiết kế cho câu biển khơi. (220 độ bền)' },
    { id: 8, name: 'Cần Đại Dương', emoji: '🌊', price: 20000000, limited: false, tier: 4, bonusLuck: 32, bonusSize: 0.45, bonusTime: 6, maxDurability: 300, desc: 'Câu được các loài cá biển sâu. (300 độ bền)' },
    { id: 9, name: 'Cần Thủy Thần', emoji: '⚓', price: 50000000, limited: false, tier: 5, bonusLuck: 48, bonusSize: 0.65, bonusTime: 10, bonusShiny: 8, maxDurability: 450, desc: 'Truyền thuyết ngư dân. (450 độ bền)' },
    { id: 10, name: 'Cần Huyền Thoại', emoji: '✨', price: 100000000, limited: false, tier: 5, bonusLuck: 65, bonusSize: 0.85, bonusTime: 12, bonusShiny: 12, maxDurability: 600, desc: 'Đỉnh cao câu cá thông thường. (600 độ bền)' },
    // Limited shop (id 11-15) - Nerf ID 14 & 15 cực mạnh
    { id: 11, name: 'Cần Băng Giá', emoji: '❄️', price: 25000000, limited: true, tier: 4, bonusLuck: 36, bonusSize: 0.5, bonusTime: 5, bonusShiny: 8, maxDurability: 350, shopWeight: 50, desc: '[GIỚI HẠN] Tăng tỉ lệ rương báu. (350 độ bền)' },
    { id: 12, name: 'Cần Lửa Địa Ngục', emoji: '🔥', price: 60000000, limited: true, tier: 5, bonusLuck: 52, bonusSize: 0.7, bonusTime: 9, bonusShiny: 10, maxDurability: 550, shopWeight: 35, desc: '[GIỚI HẠN] Tăng tỉ lệ cá tier cao. (550 độ bền)' },
    { id: 13, name: 'Cần Sét', emoji: '⚡', price: 120000000, limited: true, tier: 5, bonusLuck: 70, bonusSize: 0.9, bonusTime: 12, bonusShiny: 15, maxDurability: 800, shopWeight: 25, desc: '[GIỚI HẠN] Cá lên cực nhanh. (800 độ bền)' },
    { id: 14, name: 'Cần Bóng Tối', emoji: '🌑', price: 180000000, limited: true, tier: 5, bonusLuck: 82, bonusSize: 1.1, bonusTime: 14, bonusShiny: 20, maxDurability: 1100, shopWeight: 18, desc: '[GIỚI HẠN] Quyền năng bóng tối. (1100 độ bền)' },
    { id: 15, name: 'Cần Thần Thánh', emoji: '🌟', price: 250000000, limited: true, tier: 5, bonusLuck: 95, bonusSize: 1.3, bonusTime: 18, bonusShiny: 30, maxDurability: 1500, shopWeight: 8, desc: '[GIỚI HẠN] Tốt nhất tuyệt đối. (1500 độ bền)' },
    // Thêm 10 cần mới (id 16-25)
    { id: 16, name: 'Cần Mây', emoji: '☁️', price: 150000, limited: false, tier: 2, bonusLuck: 4, bonusSize: 0.08, bonusTime: 1, bonusShiny: 1, maxDurability: 60, desc: 'Nhẹ như mây. (60 độ bền)' },
    { id: 17, name: 'Cần Đồng', emoji: '🎣', price: 350000, limited: false, tier: 2, bonusLuck: 6, bonusSize: 0.12, bonusTime: 2, bonusShiny: 0, maxDurability: 85, desc: 'Bền chắc. (85 độ bền)' },
    { id: 18, name: 'Cần Bạc', emoji: '🎣', price: 1500000, limited: false, tier: 3, bonusLuck: 14, bonusSize: 0.22, bonusTime: 3, bonusShiny: 2, maxDurability: 120, desc: 'Câu shiny. (120 độ bền)' },
    { id: 19, name: 'Cần Vàng', emoji: '🪝', price: 5000000, limited: false, tier: 3, bonusLuck: 20, bonusSize: 0.28, bonusTime: 4, bonusShiny: 4, maxDurability: 180, desc: 'Nổi bật. (180 độ bền)' },
    { id: 20, name: 'Cần Pha Lê', emoji: '🔮', price: 15000000, limited: false, tier: 4, bonusLuck: 28, bonusSize: 0.4, bonusTime: 6, bonusShiny: 6, maxDurability: 250, desc: 'Pha lê, may mắn. (250 độ bền)' },
    { id: 21, name: 'Cần Mặt Trăng', emoji: '🌙', price: 35000000, limited: false, tier: 4, bonusLuck: 42, bonusSize: 0.6, bonusTime: 8, bonusShiny: 8, maxDurability: 350, desc: 'Hiệu quả cao. (350 độ bền)' },
    { id: 22, name: 'Cần Thiên Thạch', emoji: '☄️', price: 75000000, limited: false, tier: 5, bonusLuck: 55, bonusSize: 0.75, bonusTime: 11, bonusShiny: 10, maxDurability: 500, desc: 'Cực hiếm, mạnh mẽ. (500 độ bền)' },
    { id: 23, name: 'Cần Cầu Vồng', emoji: '🌈', price: 40000000, limited: true, tier: 4, bonusLuck: 45, bonusSize: 0.6, bonusTime: 8, bonusShiny: 12, maxDurability: 400, shopWeight: 30, desc: '[GIỚI HẠN] Tỉ lệ shiny xuất sắc. (400 độ bền)' },
    { id: 24, name: 'Cần Địa Ngục', emoji: '😈', price: 90000000, limited: true, tier: 5, bonusLuck: 62, bonusSize: 0.8, bonusTime: 13, bonusShiny: 14, maxDurability: 700, shopWeight: 20, desc: '[GIỚI HẠN] Kéo cá từ vực. (700 độ bền)' },
    { id: 25, name: 'Cần Thiên Đàng', emoji: '😇', price: 220000000, limited: true, tier: 5, bonusLuck: 88, bonusSize: 1.2, bonusTime: 16, bonusShiny: 25, maxDurability: 1300, shopWeight: 10, desc: '[GIỚI HẠN] Khí chất thiên đường. (1300 độ bền)' },
    // Siêu cần mới (id 26-35)
    { id: 26, name: 'Cần Huyết Kiếm', emoji: '🗡️', price: 120000000, limited: false, tier: 5, bonusLuck: 68, bonusSize: 0.95, bonusTime: 14, bonusShiny: 18, maxDurability: 850, desc: 'Khát máu cá biển sâu. (850 độ bền)' },
    { id: 27, name: 'Cần Hỏ Pháp', emoji: '🌊', price: 160000000, limited: false, tier: 5, bonusLuck: 76, bonusSize: 1.05, bonusTime: 15, bonusShiny: 20, maxDurability: 1000, desc: 'Chúẩn hồ pháp câu cá. (1000 độ bền)' },
    { id: 28, name: 'Cần Phượng Hoàng', emoji: '🔥', price: 220000000, limited: false, tier: 5, bonusLuck: 85, bonusSize: 1.15, bonusTime: 17, bonusShiny: 24, maxDurability: 1200, desc: 'Tái sinh từ tro tàn. (1200 độ bền)' },
    { id: 29, name: 'Cần Ngư Đế', emoji: '👑', price: 300000000, limited: false, tier: 5, bonusLuck: 98, bonusSize: 1.35, bonusTime: 19, bonusShiny: 32, maxDurability: 1600, desc: 'Đấng tối thượng của biển. (1600 độ bền)' },
    { id: 30, name: 'Cần Thần Long', emoji: '🐉', price: 400000000, limited: true, tier: 5, bonusLuck: 110, bonusSize: 1.5, bonusTime: 21, bonusShiny: 40, maxDurability: 2000, shopWeight: 7, desc: '[GIỚI HẠN] Rồng Thần hộ trì. (2000 độ bền)' },
    { id: 31, name: 'Cần Vĩnh Cửu', emoji: '♾️', price: 500000000, limited: true, tier: 5, bonusLuck: 125, bonusSize: 1.7, bonusTime: 22, bonusShiny: 45, maxDurability: 2500, shopWeight: 5, desc: '[GIỚI HẠN] Sức mạnh vô tận. (2500 độ bền)' },
    { id: 32, name: 'Cần Hắc Âm', emoji: '⚫', price: 180000000, limited: true, tier: 5, bonusLuck: 80, bonusSize: 1.1, bonusTime: 17, bonusShiny: 22, maxDurability: 1200, shopWeight: 15, desc: '[GIỚI HẠN] Bóng tối hoàn toàn. (1200 độ bền)' },
    { id: 33, name: 'Cần Mặt Trời', emoji: '☀️', price: 280000000, limited: true, tier: 5, bonusLuck: 95, bonusSize: 1.3, bonusTime: 19, bonusShiny: 30, maxDurability: 1600, shopWeight: 9, desc: '[GIỚI HẠN] Sức mạnh mặt trời. (1600 độ bền)' },
    ...
    { id: 99, name: 'Quyền Trượng Admin', emoji: '👑', price: 999999999999, limited: true, tier: 5, bonusLuck: 999999, bonusSize: 50.0, bonusTime: 100, bonusShiny: 99999, maxDurability: 9999999, shopWeight: 0, desc: '[ĐỘC QUYỀN] Chỉ Admin mới có thể sử dụng. Gãy cần là chuyện không thể.' },
];
