...
const RODS = [
    ...
    { id: 23, name: 'Cần Cầu Vồng', emoji: '🌈', price: 35000000, limited: true, tier: 4, bonusLuck: 38, bonusSize: 0.6, bonusTime: 8, bonusShiny: 18, maxDurability: 900, desc: '[GIỚI HẠN] Tỉ lệ shiny xuất sắc. (900 độ bền)' },
    { id: 24, name: 'Cần Địa Ngục', emoji: '😈', price: 80000000, limited: true, tier: 5, bonusLuck: 55, bonusSize: 0.85, bonusTime: 12, bonusShiny: 17, maxDurability: 2000, desc: '[GIỚI HẠN] Kéo cá từ vực. (2000 độ bền)' },
    { id: 25, name: 'Cần Thiên Đàng', emoji: '😇', price: 200000000, limited: true, tier: 5, bonusLuck: 72, bonusSize: 1.1, bonusTime: 17, bonusShiny: 26, maxDurability: 6500, desc: '[GIỚI HẠN] Chỉ kém Cần Thần Thánh. (6500 độ bền)' },
    // Siêu cần mới (id 26-35)
    { id: 26, name: 'Cần Huyết Kiếm', emoji: '🗡️', price: 120000000, limited: false, tier: 5, bonusLuck: 58, bonusSize: 0.88, bonusTime: 13, bonusShiny: 15, maxDurability: 2200, desc: 'Khát máu cá biển sâu. (2200 độ bền)' },
    { id: 27, name: 'Cần Hỏ Pháp', emoji: '🌊', price: 160000000, limited: false, tier: 5, bonusLuck: 65, bonusSize: 0.95, bonusTime: 14, bonusShiny: 18, maxDurability: 2800, desc: 'Chúẩn hồ pháp câu cá. (2800 độ bền)' },
    { id: 28, name: 'Cần Phượng Hoàng', emoji: '🔥', price: 220000000, limited: false, tier: 5, bonusLuck: 72, bonusSize: 1.05, bonusTime: 15, bonusShiny: 20, maxDurability: 3500, desc: 'Tái sinh từ tro tàn. (3500 độ bền)' },
    { id: 29, name: 'Cần Ngư Đế', emoji: '👑', price: 300000000, limited: false, tier: 5, bonusLuck: 78, bonusSize: 1.15, bonusTime: 16, bonusShiny: 22, maxDurability: 4500, desc: 'Đấng tối thượng của biển. (4500 độ bền)' },
    { id: 30, name: 'Cần Thần Long', emoji: '🐉', price: 400000000, limited: true, tier: 5, bonusLuck: 85, bonusSize: 1.3, bonusTime: 19, bonusShiny: 35, maxDurability: 9000, desc: '[GIỚI HẠN] Rồng Thần hộ trì. (9000 độ bền)' },
    { id: 31, name: 'Cần Vũnh Cậu', emoji: '♾️', price: 500000000, limited: true, tier: 5, bonusLuck: 90, bonusSize: 1.4, bonusTime: 20, bonusShiny: 40, maxDurability: 12000, desc: '[GIỚI HẠN] Không bao giờ gãy. (12000 độ bền)' },
    { id: 32, name: 'Cần Hắc Am', emoji: '⚫', price: 180000000, limited: true, tier: 5, bonusLuck: 68, bonusSize: 1.0, bonusTime: 15, bonusShiny: 22, maxDurability: 3200, desc: '[GIỚI HẠN] Bóng tối hoàn toàn. (3200 độ bền)' },
    { id: 33, name: 'Cần Mặt Trời', emoji: '☀️', price: 250000000, limited: true, tier: 5, bonusLuck: 76, bonusSize: 1.12, bonusTime: 17, bonusShiny: 28, maxDurability: 5500, desc: '[GIỚI HẠN] Sức mạnh mặt trời. (5500 độ bền)' },
    { id: 34, name: 'Cần Tử Thần', emoji: '☠️', price: 350000000, limited: true, tier: 5, bonusLuck: 82, bonusSize: 1.25, bonusTime: 18, bonusShiny: 32, maxDurability: 7000, desc: '[GIỚI HẠN] Cá biết tö mà cắn. (7000 độ bền)' },
    { id: 35, name: 'Cần Đại Vũ Trụ', emoji: '🌌', price: 600000000, limited: true, tier: 5, bonusLuck: 100, bonusSize: 1.5, bonusTime: 22, bonusShiny: 50, maxDurability: 15000, desc: '[GIỚI HẠN] Tốt nhất tào lò vũ trụ. (15000 độ bền)' },
];
