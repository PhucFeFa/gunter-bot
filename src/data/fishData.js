...
const RODS = [
    ...
    { id: 6, name: 'Cần Titan', emoji: '🪝', price: 3000000, limited: false, tier: 3, bonusLuck: 18, bonusSize: 0.25, bonusTime: 4, maxDurability: 300, desc: 'Titan siêu bền, độ nhạy cao. (300 độ bền)' },
    { id: 7, name: 'Cần Biển Xanh', emoji: '🌊', price: 8000000, limited: false, tier: 4, bonusLuck: 25, bonusSize: 0.35, bonusTime: 5, maxDurability: 500, desc: 'Thiết kế cho câu biển khơi. (500 độ bền)' },
    { id: 8, name: 'Cần Đại Dương', emoji: '🌊', price: 20000000, limited: false, tier: 4, bonusLuck: 32, bonusSize: 0.45, bonusTime: 6, maxDurability: 800, desc: 'Câu được các loài cá biển sâu. (800 độ bền)' },
    { id: 9, name: 'Cần Thủy Thần', emoji: '⚓', price: 50000000, limited: false, tier: 5, bonusLuck: 48, bonusSize: 0.65, bonusTime: 10, bonusShiny: 8, maxDurability: 2000, desc: 'Truyền thuyết ngư dân. (2000 độ bền)' },
    { id: 10, name: 'Cần Huyền Thoại', emoji: '✨', price: 100000000, limited: false, tier: 5, bonusLuck: 65, bonusSize: 0.85, bonusTime: 12, bonusShiny: 12, maxDurability: 3500, desc: 'Đỉnh cao câu cá thông thường. (3500 độ bền)' },
    // Limited shop (id 11-15) - Nerf ID 14 & 15 cực mạnh
    { id: 11, name: 'Cần Băng Giá', emoji: '❄️', price: 25000000, limited: true, tier: 4, bonusLuck: 36, bonusSize: 0.5, bonusTime: 5, bonusShiny: 8, maxDurability: 1000, shopWeight: 50, desc: '[GIỚI HẠN] Tăng tỉ lệ rương báu. (1000 độ bền)' },
    { id: 12, name: 'Cần Lửa Địa Ngục', emoji: '🔥', price: 60000000, limited: true, tier: 5, bonusLuck: 52, bonusSize: 0.7, bonusTime: 9, bonusShiny: 10, maxDurability: 2200, shopWeight: 35, desc: '[GIỚI HẠN] Tăng tỉ lệ cá tier cao. (2200 độ bền)' },
    { id: 13, name: 'Cần Sét', emoji: '⚡', price: 120000000, limited: true, tier: 5, bonusLuck: 70, bonusSize: 0.9, bonusTime: 12, bonusShiny: 15, maxDurability: 4000, shopWeight: 25, desc: '[GIỚI HẠN] Cá lên cực nhanh. (4000 độ bền)' },
    { id: 14, name: 'Cần Bóng Tối', emoji: '🌑', price: 180000000, limited: true, tier: 5, bonusLuck: 82, bonusSize: 1.1, bonusTime: 14, bonusShiny: 20, maxDurability: 6000, shopWeight: 18, desc: '[GIỚI HẠN] Quyền năng bóng tối. (6000 độ bền)' },
    { id: 15, name: 'Cần Thần Thánh', emoji: '🌟', price: 250000000, limited: true, tier: 5, bonusLuck: 95, bonusSize: 1.3, bonusTime: 18, bonusShiny: 30, maxDurability: 8500, shopWeight: 8, desc: '[GIỚI HẠN] Tốt nhất tuyệt đối. (8500 độ bền)' },
    ...
    { id: 19, name: 'Cần Vàng', emoji: '🪝', price: 5000000, limited: false, tier: 3, bonusLuck: 20, bonusSize: 0.28, bonusTime: 4, bonusShiny: 4, maxDurability: 400, desc: 'Nổi bật. (400 độ bền)' },
    { id: 20, name: 'Cần Pha Lê', emoji: '🔮', price: 15000000, limited: false, tier: 4, bonusLuck: 28, bonusSize: 0.4, bonusTime: 6, bonusShiny: 6, maxDurability: 650, desc: 'Pha lê, may mắn. (650 độ bền)' },
    { id: 21, name: 'Cần Mặt Trăng', emoji: '🌙', price: 35000000, limited: false, tier: 4, bonusLuck: 42, bonusSize: 0.6, bonusTime: 8, bonusShiny: 8, maxDurability: 1200, desc: 'Hiệu quả cao. (1200 độ bền)' },
    { id: 22, name: 'Cần Thiên Thạch', emoji: '☄️', price: 75000000, limited: false, tier: 5, bonusLuck: 55, bonusSize: 0.75, bonusTime: 11, bonusShiny: 10, maxDurability: 2500, desc: 'Cực hiếm, mạnh mẽ. (2500 độ bền)' },
    { id: 23, name: 'Cần Cầu Vồng', emoji: '🌈', price: 40000000, limited: true, tier: 4, bonusLuck: 45, bonusSize: 0.6, bonusTime: 8, bonusShiny: 12, maxDurability: 1500, shopWeight: 30, desc: '[GIỚI HẠN] Tỉ lệ shiny xuất sắc. (1500 độ bền)' },
    { id: 24, name: 'Cần Địa Ngục', emoji: '😈', price: 90000000, limited: true, tier: 5, bonusLuck: 62, bonusSize: 0.8, bonusTime: 13, bonusShiny: 14, maxDurability: 3200, shopWeight: 20, desc: '[GIỚI HẠN] Kéo cá từ vực. (3200 độ bền)' },
    { id: 25, name: 'Cần Thiên Đàng', emoji: '😇', price: 220000000, limited: true, tier: 5, bonusLuck: 88, bonusSize: 1.2, bonusTime: 16, bonusShiny: 25, maxDurability: 7500, shopWeight: 10, desc: '[GIỚI HẠN] Khí chất thiên đường. (7500 độ bền)' },
    // Siêu cần mới (id 26-35)
    { id: 26, name: 'Cần Huyết Kiếm', emoji: '🗡️', price: 120000000, limited: false, tier: 5, bonusLuck: 68, bonusSize: 0.95, bonusTime: 14, bonusShiny: 18, maxDurability: 4200, desc: 'Khát máu cá biển sâu. (4200 độ bền)' },
    { id: 27, name: 'Cần Hỏ Pháp', emoji: '🌊', price: 160000000, limited: false, tier: 5, bonusLuck: 76, bonusSize: 1.05, bonusTime: 15, bonusShiny: 20, maxDurability: 5500, desc: 'Chúẩn hồ pháp câu cá. (5500 độ bền)' },
    { id: 28, name: 'Cần Phượng Hoàng', emoji: '🔥', price: 220000000, limited: false, tier: 5, bonusLuck: 85, bonusSize: 1.15, bonusTime: 17, bonusShiny: 24, maxDurability: 7500, desc: 'Tái sinh từ tro tàn. (7500 độ bền)' },
    { id: 29, name: 'Cần Ngư Đế', emoji: '👑', price: 300000000, limited: false, tier: 5, bonusLuck: 98, bonusSize: 1.35, bonusTime: 19, bonusShiny: 32, maxDurability: 10000, desc: 'Đấng tối thượng của biển. (10000 độ bền)' },
    { id: 30, name: 'Cần Thần Long', emoji: '🐉', price: 400000000, limited: true, tier: 5, bonusLuck: 110, bonusSize: 1.5, bonusTime: 21, bonusShiny: 40, maxDurability: 13000, shopWeight: 7, desc: '[GIỚI HẠN] Rồng Thần hộ trì. (13000 độ bền)' },
    { id: 31, name: 'Cần Vĩnh Cửu', emoji: '♾️', price: 500000000, limited: true, tier: 5, bonusLuck: 125, bonusSize: 1.7, bonusTime: 22, bonusShiny: 45, maxDurability: 17000, shopWeight: 5, desc: '[GIỚI HẠN] Sức mạnh vô tận. (17000 độ bền)' },
    { id: 32, name: 'Cần Hắc Âm', emoji: '⚫', price: 180000000, limited: true, tier: 5, bonusLuck: 80, bonusSize: 1.1, bonusTime: 17, bonusShiny: 22, maxDurability: 6500, shopWeight: 15, desc: '[GIỚI HẠN] Bóng tối hoàn toàn. (6500 độ bền)' },
    { id: 33, name: 'Cần Mặt Trời', emoji: '☀️', price: 280000000, limited: true, tier: 5, bonusLuck: 95, bonusSize: 1.3, bonusTime: 19, bonusShiny: 30, maxDurability: 9500, shopWeight: 9, desc: '[GIỚI HẠN] Sức mạnh mặt trời. (9500 độ bền)' },
    { id: 34, name: 'Cần Tử Thần', emoji: '☠️', price: 380000000, limited: true, tier: 5, bonusLuck: 105, bonusSize: 1.45, bonusTime: 20, bonusShiny: 35, maxDurability: 12000, shopWeight: 6, desc: '[GIỚI HẠN] Cá tự tìm đến mà cắn. (12000 độ bền)' },
    { id: 35, name: 'Cần Đại Vũ Trụ', emoji: '🌌', price: 700000000, limited: true, tier: 5, bonusLuck: 150, bonusSize: 2.0, bonusTime: 25, bonusShiny: 60, maxDurability: 25000, shopWeight: 3, desc: '[GIỚI HẠN] Tốt nhất toàn vũ trụ. (25000 độ bền)' },
];
